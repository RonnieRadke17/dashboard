            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                <form action="{{ route('types.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="typename" id="typename" class="mt-1 block w-full rounded-md shadow-sm dark:bg-gray-700 dark:text-white" required>
                        @error('typename')
